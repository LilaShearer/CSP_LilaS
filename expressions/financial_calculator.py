...
print("The amount of money you spend on utilties is ", utilities, "which is", utilities_percentage, "of you monthly income.")
...
print("The amount of money you have left to spend is")